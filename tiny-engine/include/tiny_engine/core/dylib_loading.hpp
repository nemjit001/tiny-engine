...
namespace tiny_engine::core
{
	...
	public:
		...
		static std::string makeLibName(std::string const& name);
		...
		static PFN_TinyEngineVoidFunc getProcAddr(DyLibHandle* pLibrary, char const* pProcName);
	};
} // namespace tiny_engine::core
